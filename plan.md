...
- [x] 1.2 `LLMProvider` Protocol + `Gemini`/`OpenAI`/`Anthropic`/generic-OpenAI-compatible implementations (M)
- [x] 1.3 structlog JSON logging with `request_id` contextvar (S)
